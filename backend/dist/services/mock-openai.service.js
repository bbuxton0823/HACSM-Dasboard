...
exports.mockCustomReport = exports.mockStreamingReport = exports.mockBudgetForecast = exports.mockVoucherTypeReport = exports.mockExecutiveSummary = void 0;
// Mock executive summary
exports.mockExecutiveSummary = `
...
const mockVoucherTypeReport = (voucherType) => `
...
`;
exports.mockVoucherTypeReport = mockVoucherTypeReport;
// Mock budget forecast
const mockBudgetForecast = (months) => `
...
`;
exports.mockBudgetForecast = mockBudgetForecast;
// Mock streaming report
const mockStreamingReport = (reportType, options = {}) => {
    let chunks = [];
    switch (reportType) {
        case 'executive_summary':
            chunks = exports.mockExecutiveSummary.split('\n\n').map(chunk => chunk + '\n\n');
            break;
        case 'voucher_analysis':
            const voucherType = options.voucherType || 'tenant_based';
            chunks = (0, exports.mockVoucherTypeReport)(voucherType).split('\n\n').map(chunk => chunk + '\n\n');
            break;
        case 'budget_forecast':
            const months = options.forecastMonths || 6;
            chunks = (0, exports.mockBudgetForecast)(months).split('\n\n').map(chunk => chunk + '\n\n');
            break;
        default:
...
exports.mockStreamingReport = mockStreamingReport;
// Mock custom report
const mockCustomReport = (customPrompt) => {
...
exports.mockCustomReport = mockCustomReport;
